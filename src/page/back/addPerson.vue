  ...
  <div class="body">
    ...
    <el-card class="box-card">
      <el-row :gutter="20" style="margin-top: 10px; margin-bottom: 5px;">
        ...
        <el-col :offset="1" :span="2">
          <div class="bar">
            <el-button type="primary" style="margin-right: 20px" @click="exportExcel ">导出周报</el-button>
          </div>
        </el-col>
      ...
      >
        ...
        <el-table-column width="300" prop="adminId" label="所属建管单位" align="center"></el-table-column>
        ...
        <el-table-column
          ...
          align="center"
        ></el-table-column>
        <el-table-column width="300" prop="contactPerson" label="所属建管单位联系人" align="center"></el-table-column>
...
export default {
  ...
  methods: {
         ...
         try {
             FileSaver.saveAs(new Blob([wbout], { type: 'application/octet-stream' }), '周报信息.xlsx')
