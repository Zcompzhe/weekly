<template>
  <el-card class="box-card">
    <el-tabs v-model="viewname" class="cardTab">
      <el-tab-pane label="项目信息管理" name="first" class="tabPane">
            ...
            <el-row :gutter="20">
              ...
              <el-col :span="6">
                <div class="containerHeaderDiv2">
                  ...
                  <el-input v-model="projectName" class="nameInput" placeholder="请输入项目名称"></el-input>
                  <span class="inputTag">项目名称</span>
                </div>
              </el-col>
            </el-row>
            <hr />
            ...
            >
              ...
              <el-table-column width="100" label="操作" align="center">
                <template slot-scope="scope">
                  <el-button type="text" @click="modifyProjectInfo(scope.row)">修改</el-button>
                  <el-button type="text" @click="deleteProjectInfo(scope.row)">删除</el-button>
                </template>
              </el-table-column>
            </el-table>
          </el-main>
    ...
    <el-dialog :modal="false" title="添加项目信息" :visible.sync="addProjectInfo" width="30%">
      <el-row :gutter="10">
        <el-col :span="8">
          <div class="bar">
      ...
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" @click="addProjectInfo = false">取 消</el-button>
        <el-button type="primary" @click="addProject">确 定</el-button>
      </span>
    </el-dialog>

    <el-dialog :modal="false" title="修改项目信息" :visible.sync="updateProjectInfo" width="30%">
      <el-row :gutter="10">
        <el-col :span="8">
          <div class="bar">
            <div class="title">项目名称</div>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" @click="updateProjectInfo = false">取 消</el-button>
...
export default {
  ...
  methods: {
    ...
    updateProject() {
      ...
      this.$axios
        .get(`${window.$config.HOST}/baseInfoManagement/updateProject`, {
          params: {
    ...
    addProject() {
      ...
      this.$axios
        .get(`${window.$config.HOST}/baseInfoManagement/addProject`, {
          params: {
    ...
    handleNewInfoClick() {
      this.addProjectInfo = true;
    },
    modifyProjectInfo(row) {
      (this.updateProjectInfo = true), (this.updateProjectName = row.name);
    }
  }
};
</script>
