  ...
  <div class="body">
          ...
          <el-col :span="8">
            <div class="bar">
              <el-form-item label="项目名称" prop="projectIdName" placeholder="项目名称">
                <el-select :disabled="isUpdate" v-model="addFormTwo.projectIdName" clearable placeholder="请选择" style="min-width:200px" @change="projectChanged">
          ...
          <el-col :span="8">
            <div class="bar">
              <el-form-item label="建设管理单位" prop="adminId" placeholder="当前月份">
                <el-select :disabled="isUpdate" v-model="addFormTwo.adminId" clearable placeholder="请选择" style="min-width:200px">
          ...
          <el-col :span="8">
            <div class="bar">
              <el-form-item label="监理单位" prop="supervisionId" placeholder="周报开始日期">
                <el-select :disabled="isUpdate" v-model="addFormTwo.supervisionId" clearable placeholder="请选择" style="min-width:200px">
          ...
          <el-col :span="8">
            <div class="bar">
              <el-form-item label="所在区域" prop="districtId" placeholder="项目名称">
                <el-select :disabled="isUpdate" v-model="addFormTwo.districtId" clearable placeholder="请选择" style="min-width:200px">
      ...
      <el-table :data="addFormFour.weeklyWorkProgressAddReqs" @selection-change="selectWeeklyWorkProgressAddReqs" border>
        ...
        <el-table-column width="400" prop="jobNumber" label="工程编号" align="center">
          <template slot-scope="scope">
            <el-cascader v-model="scope.row.jobNumber" :options="addFormFour.options.jobNumberOptions" @change="jobNumberChanged(scope.index, scope.row)" :props="optionPropsA" style="min-width:300px"></el-cascader>
          </template>
        </el-table-column>
    ...
    <el-card class="box-card">
      ...
      <el-table :data="addFormFour.weeklyConstructContentAddReqs" @selection-change="selectWeeklyConstructContentAddReqs" border>
        ...
        <el-table-column width="400" prop="jobNumber" label="工程编号" align="center">
          <template slot-scope="scope">
            <el-cascader v-model="scope.row.jobNumber" :options="addFormFour.options.jobNumberOptions" :props="optionPropsA" @change="jobNumberChanged(scope.index,scope.row)" style="min-width:300px"></el-cascader>
          </template>
        </el-table-column>
    ...
    <el-card class="box-card">
      ...
      <el-table :data="addFormFour.weeklyRiskContentAddReqs" @selection-change="selectWeeklyRiskContentAddReqs" border>
        ...
        <el-table-column width="400" prop="workProcess" label="工序" align="center">
          <template slot-scope="scope">
            <el-cascader v-model="scope.row.workProcess" :props="optionPropsB" :options="addFormFour.options.workProcessOptions" @change="workProcessChanged(scope.index, scope.row)" style="min-width:350px"></el-cascader>
          </template>
        </el-table-column>
