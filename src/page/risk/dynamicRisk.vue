        ...
        <el-tabs v-model="activeName" @tab-click="handleClick">
          <el-tab-pane label="U1人员因素" name="first">
            ...
            <el-row :gutter="20">
              <el-col :span="20">
                <div class="bar">
                  <el-checkbox-group :max="1" @change="calculateRisk" v-model="radio11">
            ...
            <el-row :gutter="20">
              <el-col :span="20">
                <div class="bar">
                  <el-checkbox-group :max="1" @change="calculateRisk" v-model="radio12">
            ...
            <el-row :gutter="20">
              <el-col :span="20">
                <div class="bar">
                  <el-checkbox-group :max="1" @change="calculateRisk" v-model="radio13">
          ...
          <el-tab-pane label="U2机械因素" name="second">
            ...
            <el-row :gutter="20">
              <el-col :span="20">
                <div class="bar">
                  <el-checkbox-group :max="1" @change="calculateRisk" v-model="radio21">
            ...
            <el-row :gutter="20">
              <el-col :span="20">
                <div class="bar">
                  <el-checkbox-group :max="1" @change="calculateRisk" v-model="radio22">
            ...
            <el-row :gutter="20">
              <el-col :span="20">
                <div class="bar">
                  <el-checkbox-group :max="1" @change="calculateRisk" v-model="radio23">
          ...
          <el-tab-pane label="U3环境因素" name="third">
            ...
            <el-row :gutter="20">
              <el-col :span="20">
                <div class="bar">
                  <el-checkbox-group :max="1" @change="calculateRisk" v-model="radio31">
            ...
            <el-row :gutter="20">
              <el-col :span="20">
                <div class="bar">
                  <el-checkbox-group :max="1" @change="calculateRisk" v-model="radio32">
            ...
            <el-row :gutter="20">
              <el-col :span="20">
                <div class="bar">
                  <el-checkbox-group :max="1" @change="calculateRisk" v-model="radio33">
            ...
            <el-row :gutter="20">
              <el-col :span="20">
                <div class="bar">
                  <el-checkbox-group :max="1" @change="calculateRisk" v-model="radio34">
            ...
            <el-row :gutter="20">
              <el-col :span="20">
                <div class="bar">
                  <el-checkbox-group :max="1" @change="calculateRisk" v-model="radio35">
            ...
            <el-row :gutter="20">
              <el-col :span="20">
                <div class="bar">
                  <el-checkbox-group :max="1" @change="calculateRisk" v-model="radio36">
            ...
            <el-row :gutter="20">
              <el-col :span="20">
                <div class="bar">
                  <el-checkbox-group :max="1" @change="calculateRisk" v-model="radio37">
          ...
          <el-tab-pane label="U4管理因素" name="fourth">
            ...
            <el-row :gutter="20">
              <el-col :span="20">
                <div class="bar">
                  <el-checkbox-group :max="1" @change="calculateRisk" v-model="radio41">
            ...
            <el-row :gutter="20">
              <el-col :span="20">
                <div class="bar">
                  <el-checkbox-group :max="1" @change="calculateRisk" v-model="radio42">
            ...
            <el-row :gutter="20">
              <el-col :span="20">
                <div class="bar">
                  <el-checkbox-group :max="1" @change="calculateRisk" v-model="radio43">
            ...
            <el-row :gutter="20">
              <el-col :span="20">
                <div class="bar">
                  <el-checkbox-group :max="1" @change="calculateRisk" v-model="radio44">
            ...
            <el-row :gutter="20">
              <el-col :span="20">
                <div class="bar">
                  <el-checkbox-group :max="1" @change="calculateRisk" v-model="radio45">
            ...
            <el-row :gutter="20">
              <el-col :span="20">
                <div class="bar">
                  <el-checkbox-group :max="1" @change="calculateRisk" v-model="radio46">
            ...
            <el-row :gutter="20">
              <el-col :span="20">
                <div class="bar">
                  <el-checkbox-group :max="1" @change="calculateRisk" v-model="radio47">
